...
3. __Code Style:__ Write clear code that is easier to Quality Assure by following [The tidyverse style guide](https://style.tidyverse.org). Though it's much less effor to style your code automaticlly by running the [RStudio Styler add-in](http://styler.r-lib.org).
