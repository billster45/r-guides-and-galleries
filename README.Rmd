...
7. __ggplot step-by-step:__ Learn now to build ggplot charts step-by-step with this [flipbook guide](https://evamaerey.github.io/ggplot_flipbook/ggplot_flipbook_xaringan.html#1). While [this version](https://evamaerey.github.io/tidyverse_in_action/tidyverse_in_action.html#1) also includes some simple data preparation examples before building the charts step-by-step.
...
10. __Consider animation:__ If the movment of data points in your plots supports and helps better explain the story you are telling data consider creating animated plots using [gganimate](https://github.com/billster45/gganimate-experiments/blob/master/README.md).